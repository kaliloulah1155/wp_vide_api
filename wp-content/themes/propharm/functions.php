    ...
    if (class_exists('Woocommerce')){
        ...
        ---------------*/
            ...
            ---------------*/
                ...
                add_action('init','propharm_enovathemes_woocommerce_nav');
                function propharm_enovathemes_woocommerce_nav(){
                    ...
                    if ($product_navigation == 'loadmore' || $product_navigation == 'infinite') {
