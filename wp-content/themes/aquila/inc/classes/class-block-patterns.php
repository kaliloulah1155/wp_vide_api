        ...
        if(function_exists('register_block_pattern')){
        	...
        	register_block_pattern(
				...
				[
					...
					'categories'=>['cover'], //permet d'ajout le block pattern dans la partie categorie
			...
			register_block_pattern(
				...
				[
					...
					'description'=> __( 'Aquila two column Block with heading and text', 'aquila' ),
					'categories'=>['columns'], //permet d'ajout le block pattern dans la partie categorie
