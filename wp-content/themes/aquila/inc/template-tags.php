...
if ( ! function_exists( 'aquila_posted_on' ) ) :
	/**
...
if ( ! function_exists( 'aquila_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'aquila_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function aquila_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'aquila' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'aquila_post_thumbnail' ) ) :
	/**
