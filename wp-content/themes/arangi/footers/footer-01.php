...
<?php
	...
	$footer_01_show_newsletter = Arangi::setting('footer_01_show_newsletter');
...
<footer  id="page-footer" <?php Arangi::footer_class(); ?>>
	<div id="page-footer-inner" class="page-footer-inner <?php echo esc_attr($f_hide_newsletter_class); ?>" data-sticky="1">
		<?php if($footer_01_show_newsletter)  {
		   if($show_newsletter) {
					        ...
					        if ($cols) :
					            ...
					            switch ($cols) {
					                ...
					                case 4:
					                    ...
					                    break;
					                case 5:
					                    $col_class[1] = 'col-xs-12 col-sm-6 col-md-3 col-lg-2';
					                    ...
					                    $col_class[5] = 'col-xs-12 col-sm-12 col-md-12 col-lg-4';
					                    break;
					            }
					            ?>
					        <div class="row">
