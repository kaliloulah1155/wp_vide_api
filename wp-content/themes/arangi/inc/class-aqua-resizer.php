...
if(!class_exists('Arangi_Resize')) {
    ...
    class Arangi_Resize
    {
        ...
        /**
         * For your custom default usage you may want to initialize an Arangi_Resize object by yourself and then have own defaults
         */
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
               ...
               // if ( true === $upscale ) remove_filter( 'image_resize_dimensions', array( $this, 'aq_upscale' ) );
                ...
                error_log('Arangi_Resize.process() error: ' . $ex->getMessage());
...
if(!function_exists('arangi_resize')) {

    /**
     * This is just a tiny wrapper function for the class above so that there is no
     * need to change any code in your own WP themes. Usage is still the same :)
     */
    function arangi_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        $aq_resize = Arangi_Resize::getInstance();
