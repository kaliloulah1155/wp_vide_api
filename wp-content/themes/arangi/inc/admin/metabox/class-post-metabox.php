...
class Apr_Core_Post_Metabox extends Apr_Core_Metabox {
	...
	public function arrowpress_metabox_quote() {
		$metabox_quote = array(
			...
			'fields'     => array(
				...
				array(
					'id'                => 'post_quote_name',
					'label'             => esc_attr__( 'Quote Format - Source Name', 'apr-core' ),
					'desc'              => esc_attr__( 'Insert Quote Format - Source Name.', 'apr-core' ),
					'type'              => 'text',
					'default'           => '',
				),
				array(
					'id'                => 'post_quote_url',
					'label'             => esc_attr__( 'Quote Format - Source Url', 'apr-core' ),
					'desc'              => esc_attr__( 'Insert Quote Format - Source Url.', 'apr-core' ),
					'type'              => 'text',
					'default'           => '',
				),
			),
			...
			array(
				...
				'fields' => array(
					array(
						...
						'desc'    => esc_html__( 'Choose single post style ', 'apr-core' ),
						'options' => array(
							'default'  => esc_html__( 'Default', 'apr-core' ),
							'single-1' => esc_html__( 'Single 1', 'apr-core' ),
							'single-2' => esc_html__( 'Single 2', 'apr-core' ),
						),
						'default' => 'default',
					),
 				),
