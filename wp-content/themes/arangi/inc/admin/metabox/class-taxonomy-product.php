...
class Apr_Core_Taxonomy_Product_Metabox {
	...
	protected function getDefaultTaxMetaData() {
		...
		return array(
			array(
				'name'    => 'product_main_layout',
				'title'   => esc_html__( 'Main Layout', 'apr-core' ),
			...
			'bg_body_section'       => array(
				'name'    => 'bg_body_shop',
				'title'   => esc_html__( 'Background Image Body', 'apr-core' ),
				'desc'    => esc_html__( 'Upload Background Image For Body', 'apr-core' ),
				'type'    => 'upload',
				'default' => '',
			),
			'header_type'           => array(
				'name'    => 'header_type',
				'title'   => esc_html__( 'Header Type', 'apr-core' ),
				'type'    => 'select',
				'options' => $apr_header,
				'default' => '',
			),
			'fixed_header'          => array(
				'name'  => 'fixed_header',
				'title' => esc_html__( 'Fixed Header', 'apr-core' ),
				'type'  => 'checkbox',
			),
			'hide_header'           => array(
				'name'  => 'hide_header',
			...
			'footer_type'           => array(
				'name'    => 'footer_type',
				'title'   => esc_html__( 'Footer Type', 'apr-core' ),
				'type'    => 'select',
				'options' => $apr_footer,
				'default' => '',
			),
			...
			'product_columns'       => array(
				...
				'desc'    => esc_html__( 'Select product columns. Note: Option 4 col, 5 col, 6 col not for cases where the page has 2 sidebar (left and right); Option 6 col not for cases where the page has sidebar left or right.', 'apr-core' ),
				'type'    => 'select',
				'default' => '',
				'options' => array(
					''  => esc_html__( 'Default', 'apr-core' ),
					...
					'5' => esc_html__( '5 col', 'apr-core' ),
					'6' => esc_html__( '6 col', 'apr-core' ),
				),
			),
			...
			/*'product_pagination' => array(
				...
				'desc' => esc_html__('Select product pagination', 'apr-core'),
				'type' => 'select',
				'options' => array(
					'default' => esc_html__('Default','apr-core'),
			...
			'product_cate_number'   => array(
				'name'    => 'product_cate_number',
				'type'    => 'text',
				'title'   => esc_html__( '[Desktop] Number of categories to show', 'apr-core' ),
				'desc'    => esc_html__( 'This option will work if you select to display categories in option display type Both or Subcategories.', 'apr-core' ),
				'default' => '',
			),
		);
	}
...
new Apr_Core_Taxonomy_Product_Metabox( 'product_cat' );
