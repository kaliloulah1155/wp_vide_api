...
class Apr_Core_Taxonomy_Metabox {
	...
	public function createTable() {
		...
		if ( get_option( 'arangi_' . $tableName ) ) {
			return false;
		}
		...
		if ( ! $wpdb->get_var( "SHOW TABLES LIKE '$tableName'" ) == $tableName ) {
			...
			$wpdb->query( $sql );
			update_option( 'arangi_' . $tableName, true );
		}
	...
	protected function getDefaultTaxMetaData() {
		...
		return array(
			...
			'blog_grid_style' => array(
				'name'     => 'blog_grid_style',
				'title'    => esc_html__( 'Blog grid style', 'apr-core' ),
				'desc'     => esc_html__( 'Select style for layout grid', 'apr-core' ),
				'type'     => 'select',
				'options'  => array(
					''       => esc_html__( 'Default', 'apr-core' ),
					'style1' => esc_html__( 'Grid Style 1', 'apr-core' ),
					'style2' => esc_html__( 'Grid Style 2', 'apr-core' ),
				),
				'required' => array(
					array(
						'name'  => 'blog_layout',
...
new Apr_Core_Taxonomy_Metabox( 'category' );
