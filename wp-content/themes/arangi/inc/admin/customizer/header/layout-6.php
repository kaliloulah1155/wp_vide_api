<?php 
$section  = 'header_layout_6';
$priority = 1;
$prefix   = 'header_layout_6_';

arrowpress_customizer() ->add_field(   array(
    'type'     => 'image',
    'settings' => 'image-header-6',
    'section'  => $section,
    'priority' => $priority ++,
    'transport' => 'auto',
    'default'  => ARANGI_THEME_URI . '/assets/images/header/header-6.jpg',
) );
/*--------------------------------------------------------------
# header
--------------------------------------------------------------*/
arrowpress_customizer() ->add_field(   array(
    'type'     => 'custom',
    'settings' => $prefix . 'group_title_' . $priority ++. "_6",
    'section'  => $section,
    'priority' => $priority ++,
...
arrowpress_customizer() ->add_field(   array(
    ...
    'priority' => $priority ++,
    'transport' => 'auto',
    'default'  => ARANGI_THEME_URI . '/assets/images/logo-6.png',
) );
...
arrowpress_customizer() ->add_field(   array(
	...
	'output'      => array(
		array(
			'element'  => '.header-06,
							#page.header-06:not(.header-fixed) .fix-top',
...
arrowpress_customizer() ->add_field(   array(
	...
	'output'      => array(
		array(
			'element'  => '.site-header.header-06',
		),
	),
	'required'  => array(
        array(
            'setting'  => 'header_layout_6_bg_img',
            'operator' => '==',
            'value'    => 1,
        ),
    ), 
...
arrowpress_customizer() ->add_field(   array(
	'type'        => 'color',
	'settings'    => $prefix . 'overlay_color_6',
		...
		array(
			'element'  => array(
				'.header-06 .logo,
				 ...
				 .header-06 .header-middle .header-menu',
			),
			'property' => 'height',
		),
	),
...
arrowpress_customizer() ->add_field(   array(
    'type'     => 'text',
    'settings' => 'icon_settings_6',
    'label'    => __( 'Enter my account icon class', 'arangi' ),
    'section'  => $section,
    'default'  => esc_attr__( 'ti-unlock', 'arangi' ),
    'priority' => $priority ++,
    'required'  => array(
        array(
            'setting'  => 'show_settings_6',
            'operator' => '==',
            'value'    => 1,
        ),
    ),
...
arrowpress_customizer() ->add_field(   array(
    ...
    'output'      => array(
        array(
            'element'  => '.header-06 .header-icon .cart-header,
						   .header-06 .header-icon .account-header > a, 
						   .header-06 .header-icon .header-contact a, 
						   .header-06 .header-icon .search-header',
            'property' => 'color',
        ),
    ),
) );
...
arrowpress_customizer() ->add_field(   array(
    'type'        => 'color',
    'settings'    => $prefix . 'icon_color_hover_6',
    ...
    'output'      => array(
        array(
            'element'  => '.header-06 .header-icon .cart-header:hover,
						   .header-06 .header-icon .account-header > a:hover, 
						   .header-06 .header-icon .header-contact i:hover, 
						   .header-06 .header-icon .search-header:hover',
            'property' => 'color',
        ),
    ),
) );
...
arrowpress_customizer() ->add_field(   array(
    'type'     => 'custom',
    'settings' => $prefix . 'group_title_menu' . $priority ++. "_6",
    'section'  => $section,
    'priority' => $priority ++,
...
arrowpress_customizer() ->add_field(   array(
    'type'        => 'slider',
    'settings'    => $prefix . 'navigation_item_font_size_6',
    ...
    'output'      => array(
        array(
            'element'  => '.header-06 .header-middle .mega-menu > li > a',
            'property' => 'font-size',
            'units'    => 'px',
        ),
    ),
...
arrowpress_customizer() ->add_field(   array(
    'type'        => 'color',
    'settings'    => $prefix . 'navigation_link_hover_color_6',
    ...
    'output'      => array(
        array(
            'element'  =>
                '.header-06 .header-middle  .mega-menu > li:focus > a, 
                .header-06 .header-middle .mega-menu> li:hover > a',
            'property' => 'color',
        ),
    ),
) );
...
arrowpress_customizer() ->add_field(   array(
    'type'        => 'typography',
    'settings'    => $prefix . 'navigation_typography_6',
...
arrowpress_customizer() ->add_field(   array(
    'type'      => 'spacing',
    'settings'  => $prefix . 'navigation_6_item_padding',
    ...
    'output'    => array(
        array(
            'element'  => array(
                '.header-06 .header-middle .mega-menu > li > a',
            ),
            'property' => 'padding',
        ),
    ),
