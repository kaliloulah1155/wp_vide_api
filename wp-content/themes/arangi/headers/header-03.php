                ...
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 align-items-center menu-col-right">
                    <div class="header-right d-flex align-items-center justify-content-end">
                        <div class="header-icon">
                            <?php
                            $show_search_3 = Arangi::setting('show_search_3');
                            $icon_search_3 = Arangi::setting('icon_search_3');
                            $show_contact_3 = Arangi::setting( 'show_contact_3' );
                            $show_lang_3 = Arangi::setting( 'show_lang_3' );
                            $phone_contact = Arangi::setting('phone_contact');
                            $icon_contact_3 = Arangi::setting('icon_contact_3');
                            if ($show_search_3 && $icon_search_3) {
                                ?>
                                <div class ="search-header d-inline-block">
                                    <div class="icon-header btn-search">
                                        <i class="<?php echo esc_attr($icon_search_3); ?>"></i>
                                    </div>
                                </div>
                                <?php
                            }
                            $show_mini_cart_3 = Arangi::setting('show_mini_cart_3');
                            if ($show_mini_cart_3) {
                                Arangi_Templates::get_minicart_template();
                            }
                            $show_settings_3 = Arangi::setting('show_settings_3');
                            if ($show_settings_3) {
                                Arangi_Templates::get_setting_template();
                            }
                            ?>
                            <?php if ($show_contact_3 == 'show'){?>
                                <div class="header-contact">
                                    <a href="tel:<?php echo esc_attr($phone_contact)?>"><i class="<?php echo esc_attr($icon_contact_3);?>"></i></a>
                                </div>
                            <?php }?>
                            <?php if ($show_lang_3 == 'show'){
